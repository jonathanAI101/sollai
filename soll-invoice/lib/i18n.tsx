...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    // Landing Page
    'landing.login': '进入应用',
    'landing.hero.title': '为创作者经济而生',
    'landing.hero.subtitle': '全球内容变现，即时收款，保留更多收益。',
    'landing.feature1.title': 'AI 驱动核心',
    'landing.feature1.desc': '不只是使用 AI — 我们就是 AI 基础设施。联邦学习、实时优化、隐私保护智能。',
    'landing.feature2.title': '一个平台，全球覆盖',
    'landing.feature2.desc': '50+ 种货币，200+ 种支付方式，20+ 个市场。为无国界创作者提供无国界支付。',
    'landing.feature3.title': '即时、智能、无感',
    'landing.feature3.desc': 'AI 驱动路由节省 25% 成本。实时结算，跨境支付简单化。',
    'landing.feature4.title': '创作者经济专属',
    'landing.feature4.desc': '全球内容变现，即时收款，保留更多收益。',
    'landing.stats.currencies': '种货币',
    'landing.stats.methods': '种支付方式',
    'landing.stats.markets': '个市场',
    'landing.stats.savings': '成本节省',
    'landing.cta.start': '开始使用',
    'landing.cta.title': '准备好开始了吗？',
    'landing.cta.subtitle': '加入全球创作者，开启智能支付之旅。',
    'landing.footer.privacy': 'AI 驱动的全球支付基础设施',
  ...
  en: {
    ...
    'landing.hero.title': 'Built for the Creator Economy',
    'landing.hero.subtitle': 'Monetize content globally. Get paid instantly. Keep more of what you earn.',
    'landing.feature1.title': 'Built with AI at the Core',
    'landing.feature1.desc': 'Not just using AI — we ARE AI infrastructure. Federated learning, real-time optimization, privacy-preserving intelligence.',
    'landing.feature2.title': 'One Platform, Global Reach',
    'landing.feature2.desc': '50+ currencies, 200+ payment methods, 20+ markets. Borderless payments for borderless creators.',
    'landing.feature3.title': 'Instant, Intelligent, Invisible',
    'landing.feature3.desc': 'AI-powered routing cuts costs by 25%. Real-time settlement. Cross-border made simple.',
    'landing.feature4.title': 'Built for the Creator Economy',
    'landing.feature4.desc': 'Monetize content globally. Get paid instantly. Keep more of what you earn.',
    'landing.stats.currencies': 'Currencies',
    'landing.stats.methods': 'Payment Methods',
    'landing.stats.markets': 'Markets',
    'landing.stats.savings': 'Cost Savings',
    'landing.cta.start': 'Get Started',
    'landing.cta.title': 'Ready to get started?',
    'landing.cta.subtitle': 'Join global creators and start your intelligent payment journey.',
    'landing.footer.privacy': 'AI-powered global payment infrastructure',
